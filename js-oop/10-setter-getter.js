class Book {
    ...
    setPage(page) {
        ...
        else throw Error('Page number CANNOT zerop or less!');
    }
}
...
book1.setPage(10); // updating the amount of pages for book1 
console.log(book1.getPage()); // 10


// We still have direct access, which is bad. In the next file we will use private properties to fix this:
/*
book1.page = -100;
